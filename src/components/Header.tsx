...
export default function Header() {
  return (
    <header className="navbar fixed w-full bg-white/5 backdrop-blur-md top-0 z-50 px-8 py-6 transition-all duration-1000 ease-in-out hover:bg-white/20">
      <div className="navbar-start">
        <div className="hidden lg:flex">
          <ul className="flex gap-12">
            <li>
              <Link href="/shop" className="font-outfit text-[10px] font-black tracking-[0.4em] text-[#5a4838] opacity-40 hover:opacity-100 hover:text-[#FD2F79] uppercase">
                Collection
              </Link>
            </li>
            <li>
              <Link href="/about" className="font-outfit text-[10px] font-black tracking-[0.4em] text-[#5a4838] opacity-40 hover:opacity-100 hover:text-[#FD2F79] uppercase">
                Our Story
              </Link>
            </li>
          </ul>
